      ...
      <body className={`${inter.className} antialiased`}>
        <main className="flex min-h-screen flex-col p-6">
          <div className="flex h-30 shrink-0 items-end rounded-lg bg-amber-400 p-4 md:h-40 priority">
            ...
            />
            <p className={`${habibi.className} hidden mx-3 md:block text-xl text-black-800 md:text-5xl md:leading-normal`}>
          ...
          <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
            ...
            <div className="flex items-center justify-center md:block md:w-4/6">
              {children}
            </div>
          </div>
        </main>
